...
// import images
// import Aboutus from "../../assets/images/small/img-2.jpg"
  ...
  return (
    <React.Fragment>
      <div className="page-content">
        <MetaTags>
          <title>Solutions | Rain Computing</title>
        </MetaTags>
        <Container fluid>
          <Breadcrumbs title="Solutions" breadcrumbItem="Solutions" />
          <Row>
            <Col lg={12}>
              <Card>
                <CardBody>
                        ...
                        <div>
                          ...
                          <div className="mt-4">
                            <div className="text-muted font-size-14">
                              <h1>Appstore and enterprise software management</h1>
                              <p>
                              We establish a new way to deploy software across multiple device platforms and
                               centralize software management and licensing to reduce cost.
                              </p>

                              <h1>Private label Appstore</h1>

                              <p className="mb-4">
                              A subset of the Rain Computing Appstore functionality can be packaged as a privately 
                              branded Appstore for an enterprise to offer your own Apps, even under your IoT infrastructure.
                              We can increase your customer loyalty and reduce customer churn through increased user-friendliness.
                              </p>
                              ...
                              <h1>Turn your data into insights, and turn insights into control</h1>

                              <p>
                              Data collection and advanced analytics enable enterprise IT department to gain deep insights into end-users  software
                               consumption behavior. As a result, you can achieve better control of your corporate operation and budget.
                              </p>
